...
if(isset($_GET['user'])){ // this means you're trying to view another user's page
	...
	else { unset($_GET['user']); } // if you're trying to view your own page, show your home page
}
...
if(isset($_POST['new_woot']) && !isset($_SESSION['prev_woot'])){
	write_woot($home_user, $_POST['new_woot'],date("Y-m-d -> G:i:s", time()));
				...
				<tr > 
					...
					<td align="center">
						...
						if(isset($_GET['user'])&&!isset($user_dne)){
							list ($fnm, $lnm, $flr_num) = already_following($home_user, $other_user->id);
							if(!isset($fnm)){ echo "<input type='submit' class='button' name='follow' value='Follow' style='width:100%'>" ;  }
