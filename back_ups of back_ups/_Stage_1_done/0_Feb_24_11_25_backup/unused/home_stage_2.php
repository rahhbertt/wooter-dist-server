...
<!-- LOGGING OUT SHOULD ACTUALLY LOG OUT -->
...
<p><br><br><br>
	Welcome to 
	<?php whose($other_user); ?>
	 Wooter Home Page.
</p>



<!-- should only show 20 woots at a time, and offer a paging system
to view the rest at a time, although that will reload the page
and maybe give get tag
? page 2 or whatever
 -->

<p class="left"> <font style="background-color:cyan">
	<?php whose($other_user); ?>
 Followers: </font>
...
<p class="right"> 
	<font style="background-color:cyan"> Users 
	<?php 
	if(!isset($other_user)) { 
		echo "You're";
	}
...
<?php
	 if(!isset($other_user)){
		...
		echo "<br><br><br><br>
<p style=\"clear:both\" > <font style=\"background-color:cyan\">Other Users You Might Be Interested In:</font>
<table border=\"1\" bgcolor=\"cyan\" align=\"center\">
<tr><td>
  	<table>
	<tr>
	    <td>Random_1_Username</td>
