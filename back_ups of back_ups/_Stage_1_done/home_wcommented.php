...
// if not logging out, show the normal page
...
if(!isset($logged_in_user) &&  !isset($_GET['user']) ){
...
function show_home($string){
	if(!isset($_GET['user'])){
		echo $string;
	}
}

function hide_home($string){
	if(isset($_GET['user'])){
		echo $string;
	}	
}
			...
			<table width="100%" border="0">
				<tr> 
					...
					<td align="center">
						...
						<?php
						hide_home("<table style='border-collapse: collapse' cellpadding='10'>
